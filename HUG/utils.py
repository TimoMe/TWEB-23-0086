...
def load_text_info(filedir, dataset):

    train_data = load_pickle(os.path.join(filedir, f'word_emb_text.train.pkl'))
    val_data = load_pickle(os.path.join(filedir, f'word_emb_text.valid.pkl'))
    test_data = load_pickle(os.path.join(filedir, f'word_emb_text.test.pkl'))
    # word_emb_dict = load_pickle(os.path.join(filedir, f'word_emb_dict.pkl'))

    return train_data, val_data, test_data


def load_graph_info(graph_file, feat_file):
    graph_mat = load_pickle(graph_file)
    graph_feat = load_pickle(feat_file)
    return graph_mat, graph_feat
